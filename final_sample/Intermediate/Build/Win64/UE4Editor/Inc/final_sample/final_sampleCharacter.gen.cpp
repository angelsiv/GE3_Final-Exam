...
// End Cross Module References
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_Afinal_sampleCharacter_Statics::NewProp_PlayerWidget_MetaData[] = {
		{ "Category", "final_sampleCharacter" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "final_sampleCharacter.h" },
	};
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_Afinal_sampleCharacter_Statics::NewProp_PlayerWidget = { "PlayerWidget", nullptr, (EPropertyFlags)0x00100000000a0009, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Afinal_sampleCharacter, PlayerWidget), Z_Construct_UClass_UWidgetComponent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_Afinal_sampleCharacter_Statics::NewProp_PlayerWidget_MetaData, ARRAY_COUNT(Z_Construct_UClass_Afinal_sampleCharacter_Statics::NewProp_PlayerWidget_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_Afinal_sampleCharacter_Statics::NewProp_HP = { "HP", nullptr, (EPropertyFlags)0x0010000000020015, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Afinal_sampleCharacter, HP), METADATA_PARAMS(Z_Construct_UClass_Afinal_sampleCharacter_Statics::NewProp_HP_MetaData, ARRAY_COUNT(Z_Construct_UClass_Afinal_sampleCharacter_Statics::NewProp_HP_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_Afinal_sampleCharacter_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_Afinal_sampleCharacter_Statics::NewProp_PlayerWidget,
	...
	IMPLEMENT_CLASS(Afinal_sampleCharacter, 1041868267);
