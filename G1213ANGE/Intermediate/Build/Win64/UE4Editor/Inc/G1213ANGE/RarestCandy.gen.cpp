...
#include "G1213ANGE/RarestCandy.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	G1213ANGE_API UClass* Z_Construct_UClass_ARarestCandy_NoRegister();
	G1213ANGE_API UClass* Z_Construct_UClass_ARarestCandy();
...
// End Cross Module References
...
#endif
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ARarestCandy_Statics::NewProp_SoundCue_MetaData[] = {
		{ "Category", "RarestCandy" },
		{ "ModuleRelativePath", "RarestCandy.h" },
	};
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_ARarestCandy_Statics::NewProp_SoundCue = { "SoundCue", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ARarestCandy, SoundCue), Z_Construct_UClass_USoundBase_NoRegister, METADATA_PARAMS(Z_Construct_UClass_ARarestCandy_Statics::NewProp_SoundCue_MetaData, ARRAY_COUNT(Z_Construct_UClass_ARarestCandy_Statics::NewProp_SoundCue_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_ARarestCandy_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ARarestCandy_Statics::NewProp_SoundCue,
	...
	IMPLEMENT_CLASS(ARarestCandy, 2756180716);
	template<> G1213ANGE_API UClass* StaticClass<ARarestCandy>()
	{
		return ARarestCandy::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_ARarestCandy(Z_Construct_UClass_ARarestCandy, &ARarestCandy::StaticClass, TEXT("/Script/G1213ANGE"), TEXT("ARarestCandy"), false, nullptr, nullptr, nullptr);
